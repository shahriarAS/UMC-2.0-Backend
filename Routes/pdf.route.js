...
import { pdfView, pdfViewEnrolled, pdfCreate, pdfUpdate, pdfDelete } from "../Controllers/pdf.controler.js"
...
// PDF View Enrolled
pdfRoute.get("/viewenrolled/:courseID/:pdfID", verifyLoginMiddleware, verifyEnrolledMiddleware, pdfViewEnrolled)
